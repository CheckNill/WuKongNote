...
export  default  class CircleProgressView extends Component {
    ...
    changeProgress(progress, totalNum) {
        let degress = progress / totalNum * 360; //度数
        let target1 = null;
        //先计算 右边的
        let target = null;
    ...
    render() {
        ...
        let pushStr = "M{0},{1} A{2},{3} 0 {4},{5} {6},{7}";//贝塞尔曲线绘制法
        // M100,10 A90,90 0 0,1 163.63961030678928,36.36038969321072
        console.warn('pushStr==>',pushStr);
        let result = pushStr.format(this.state.startX, this.state.startY, this.state.originR, this.state.originR,
